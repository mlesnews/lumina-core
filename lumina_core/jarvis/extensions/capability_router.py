...
class JarvisCapabilityRouter:
    ...
    def _calculate_base_score(self, extension_name: str, capability: str) -> float:
        ...
        # This would be loaded from capabilities.json for each extension
        ...
        return base_scores.get(extension_name, {}).get(capability, 0.7)
    ...
    def optimize_weights(self):
        ...
        # This would implement machine learning to optimize the routing weights
