...
- NAS Mail Hub settings (10.17.17.32)
...
### Step 4: Verify Setup
1. Check NAS Mail Hub webmail: https://10.17.17.32:5001/mailplus
...
- **Issue:** Cannot connect to 10.17.17.32
...
- **Solution:** Verify username: mlesn@homelab.lesnewski.local
